...
/**
 * <p>
 * Java class for eprintsDescriptionType complex type.
 *
 * <p>
...
@XmlType(
        name = "eprintsDescriptionType", propOrder = {
                "content",
                "metadataPolicy",
                "dataPolicy",
                "submissionPolicy",
...
public class EprintsDescriptionType {
    ...
    public TextURLType content;
    @XmlElement(required = true)
    public TextURLType metadataPolicy;
    @XmlElement(required = true)
    public TextURLType dataPolicy;
    public TextURLType submissionPolicy;
